...
func TestPostgresClosedPoolErrorPaths(t *testing.T) {
	...
	calls := []call{
		...
		{"LinkRunnerProfile", func() error { return st.LinkRunnerProfile(ctx, runnerID, profileID) }},
		{"ProfileForRunnerID", func() error { _, _, err := st.ProfileForRunnerID(ctx, runnerID); return err }},
		{"UnlinkRunnerProfile", func() error { return st.UnlinkRunnerProfile(ctx, runnerID) }},
		{"RunnerIDsForProfile", func() error { _, err := st.RunnerIDsForProfile(ctx, profileID); return err }},
